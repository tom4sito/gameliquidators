	...
	<!-- 		<button class="btn btn-danger" id="producttype" class="">buscar</button>-->
		...
		<div class="added-products-panel col-12 col-md-6">
			...
			<form method="post" action="" name="saleReportForm" id="saleReportForm">
				...
				<span class=''></span><br>
				<label>Notas</label>
				<textarea rows="3" cols="30" name="notes" id="notes">
				</textarea>
				<br>
...
$(document).ready(function(){
    ...
    $(document).on("click", ".result p", function(){
        ...
        product_row +=				`<p class='prod_info' product_id="${product_id}" >`+product_platform +": " +product_name+"</p>";
        product_row +=				"<p class='prod_info'>Cantidad: <input type='number' maxlength='4' value='1' name='qty[]' class='qty' min='1'><span class=''></span></p>";
        product_row +=				"<p class='prod_info'>Precio: <input type='text' maxlength='8' name='price[]' class='price'> <span class=''></span> </p>";
